...
export function createInitialState(): GameState {
  ...
  const unlockedApps: string[] = ['mycomputer', 'notepad', 'recyclebin', 'calculator', 'explorer', 'mail', 'minesweeper', 'settings'];
  return { characters, flags: {}, unlockedApps, profile: {}, activeForm: null, shakingIcon: null, bleedingIcon: null, volume: 80, muted: false };
}
